...
|   |                                            |
 \_ |                                            |
    |               GDB_name_here                |
    |                                            |
    |          By order of the Liberator         |
    |        The leader of the free people       |
    |      _______        _                      |
    |     / ___/ /  ___ _(_)_____ _  ___ ____    |
    |    / /__/ _ \/ _ `/ / __/  ' \/ _ `/ _ \   |
...
`7MM"""Mq.
  MM   `MM.
  MM   ,M9   ,6"Yb.`7M'   `MF'.gP"Ya `7MMpMMMb.
  MMmmdM9   8)   MM  VA   ,V ,M'   Yb  MM    MM
  MM  YM.    ,pm9MM   VA ,V  8M""""""  MM    MM
  MM   `Mb. 8M   MM    VVV   YM.    ,  MM    MM
.JMML. .JMM.`Moo9^Yo.   W     `Mbmmd'.JMML  JMML.

   .g8""8q.
 .dP'    `YM.
 dM'      `MM `7MM  `7MM  .gP"Ya   .gP"Ya `7MMpMMMb.
 MM        MM   MM    MM ,M'   Yb ,M'   Yb  MM    MM
 MM.      ,MP   MM    MM 8M"""""" 8M""""""  MM    MM
 `Mb.    ,dP'   MM    MM YM.    , YM.    ,  MM    MM
   `"bmmd"'     `Mbod"YML.`Mbmmd'  `Mbmmd'.JMML  JMML.
       MMb
         `^^^"
